...
class PawApiClient(
    ...
    override suspend fun requestOtp(phone: String): JSONObject = requestJson(
        method = "POST",
        path = "/auth/request-otp",
        body = JSONObject().put("phone", phone),
    )

    override suspend fun verifyOtp(phone: String, code: String): JSONObject = requestJson(
        method = "POST",
    ...
    override suspend fun getMe(): JSONObject = requestJson(method = "GET", path = "/users/me")

    override suspend fun updateMe(username: String, discoverableByPhone: Boolean): JSONObject = requestJson(
        method = "PATCH",
        path = "/users/me",
        body = JSONObject()
